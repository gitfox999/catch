...
<div class="pageHeader">
	<form class="advancedSearchForm" style="display: none;" rel="pagerForm_hidden"  onsubmit="return navTabSearch(this);" action="${webUrl}/roles" method="POST">
	<div class="searchBar">
...
<form class="fullTextSearchForm"  rel="pagerForm" onsubmit="return navTabSearch(this);" action="${webUrl}/roles/0/search" method="POST">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="icon" href="${webUrl}/roles/0/search.xls" target="dwzExport" targetType="navTab" title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
