...
<div class="pageHeader">
	<form class="advancedSearchForm" style="display: none;" rel="pagerForm_hidden"  onsubmit="return navTabSearch(this);" action="${webUrl}/users" method="POST">
	<div class="searchBar">
...
<form class="fullTextSearchForm"  rel="pagerForm" onsubmit="return navTabSearch(this);" action="${webUrl}/users/0/search" method="POST">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${webUrl}/users/new" target="navTab" rel="users_new"><span>增加用户</span></a></li>
			...
			<li><a class="edit" href="${webUrl}/users/{user_id}/edit" rel="users_edit" target="navTab" warn="请选择一个用户"><span>修改</span></a></li>
			<li class="line">line</li>
			<li><a class="icon" href="${webUrl}/users/0/search.xls" target="dwzExport" targetType="navTab" title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
	<table class="table" asc="asc" desc="desc" width="1200" layoutH="138">
		<thead>
			<tr>
		...
		<tbody>
			...
			<tr target="user_id" rel="${user.id}">
			   ...
			   <td>
				...
				<td>${user.userExtends.age}</td>
				<td>${user.userExtends.tel}</td>
				...
				<td>
					...
					<a title="编辑" target="navTab" href="${webUrl}/users/${user.id}/edit" rel="users_edit" class="btnEdit">编辑</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
