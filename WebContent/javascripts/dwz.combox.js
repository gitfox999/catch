	...
	$.extend($.fn, {
		...
		combox:function(){
			...
			return this.each(function(i){
				...
				///修改1=================================修改 select根据返回值自动设置名称=======================================
				var label = $("option[value=" + value + "]",$this).last().text();//获取最后又一个的名称
				$("option[value=" + value + "]",$this).first().text(label);//设置给第一个
				$("option[value=" + value + "]",$this).last().remove();//删除最后一个
				//修改1=================================修改 select根据返回值自动设置名称========================================
