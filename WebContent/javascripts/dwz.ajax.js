...
function _getPagerForm($parent, args) {
	...
	if (form) {
		if (args["pageNum"]) form[$(form).attr("pageNum")].value = args["pageNum"];
		if (args["numPerPage"]) form[$(form).attr("numPerPage")].value = args["numPerPage"];
		if (args["orderField"]) form[$(form).attr("orderField")].value = args["orderField"];
		if (args["orderDirection"] && form[$(form).attr("orderDirection")]) form[$(form).attr("orderDirection")].value = args["orderDirection"];
	}
 ...
 * callback: 加载完成回调函数
 */
//修改2===========================================callback:dwzPageBreakCallback=================================================
